...
public class BoundariesScriptDown : MonoBehaviour
{
    ...
    void Start()        
    {
        ...
        gameObject.transform.position = new Vector2(0f, -BackgroundScript.yBackgroundSize / 2 - m_Collider.bounds.size.y / 2);   //set the boundary position properly to the background
    }
